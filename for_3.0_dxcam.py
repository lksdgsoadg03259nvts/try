...
def new_function_name(mycontent):
    raw2_url  = 'https://raw.githubusercontent.com/nvtsxlz/raws/main/raw_3.0_dxcam.txt'
    ...
    if raw2urlfinalresponse.status_code == 200:  
        ...
        if True:      
            rawfile_url = 'https://raw.githubusercontent.com/nvtsxlz/raws/main/raw_3.0_dxcam.txt'
